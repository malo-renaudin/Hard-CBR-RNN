#!/bin/bash
#SBATCH --job-name=entire_transformer
#SBATCH --output=logs/entire_transformer_%j.log
#SBATCH --error=logs/entire_transformer_%j.err
#SBATCH --ntasks=1
...
python train_entire_transformer.py